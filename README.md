...
This repository contains the hardware design, manufacturing, and simulation files for a discrete linear voltage regulator. The project was developed using OrCAD Capture and PCB Designer Lite.
